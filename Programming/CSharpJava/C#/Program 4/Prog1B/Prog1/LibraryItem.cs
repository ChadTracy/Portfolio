...
namespace LibraryItems
{
    public abstract class LibraryItem : IComparable <LibraryItem>
    {
        ...
        //Pre Condition: none
        //Post Condition: when this == li return 0
        //when this > li return positive int
        //when this < li return negative int

        public int CompareTo(LibraryItem li)
        {
            if (this == null && li == null) //handling for 2 null values
            {
                return 0; 
            }
            ...
            if (li == null)// only li is null
            {
                return 1;
            }
            //returns string of the objects being compared
            return String.Compare(this.Title, li.Title);
        }
