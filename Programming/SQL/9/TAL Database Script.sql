...
ALTER TABLE REPB
ADD CONSTRAINT PK_REPB PRIMARY KEY(REP_NUM)

ALTER TABLE CUSTOMERB 
ADD CONSTRAINT PK_CUSTOMERB PRIMARY KEY (CUSTOMER_NUM)

ALTER TABLE ITEMB
ADD CONSTRAINT PK_ITEMB PRIMARY KEY (ITEM_NUM)

ALTER TABLE ORDERSB
ADD CONSTRAINT PK_ORDERSB PRIMARY KEY (ORDER_NUM)

ALTER TABLE ORDER_LINEB
ADD CONSTRAINT PK_ORDER_LINEB PRIMARY KEY (ORDER_NUM, ITEM_NUM)

ALTER TABLE CUSTOMERB
ADD CONSTRAINT FK_CUSTOMERB_REPB FOREIGN KEY (REP_NUM)
REFERENCES REPB

ALTER TABLE ORDERSB
ADD CONSTRAINT FK_ORDERSB_CUSTOMERSB FOREIGN KEY (SUTOMER_NUM) 
REFERENCES CUSTOMERB

ALTER TABLE ORDER_LINEB
ADD CONSTRAINT FK_ORDER_LINEB_ORDERSB FOREIGN KEY (ORDER_NUM)
REFERENCES ORDERSB, 
CONSTRAINT FK_ORDER_LINEB_ITEMB FOREIGN KEY (ITEM_NUM)
REFERENCES ITEMB
